        ...
        <Card className="border-0 shadow-sm">
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { name: "Aragorn", system: "D&D 5e", level: "Nível 5" },
                { name: "Elara", system: "Tormenta 20", level: "Nível 3" },
                { name: "Marcus", system: "Call of Cthulhu", level: "Investigador" },
              ].map((character, index) => (
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-700">Personagem "Aragorn" foi atualizado</span>
              </div>
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-700">Nova ficha "Elara" foi criada</span>
              </div>
            ...
            <div className="flex items-center justify-between py-2">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-700">Template "Tormenta 20" foi adicionado</span>
              </div>
